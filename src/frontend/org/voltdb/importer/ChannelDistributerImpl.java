 ...
 */
public class ChannelDistributerImpl implements ChannelChangeCallback, ChannelDistributer {
     ...
     * @param queue
     */
    public ChannelDistributerImpl(ZooKeeper zk, String hostId) {
     ...
     * the import channels in {@link ChannelDistributerImpl#m_specs}, and if the host
